...
#        print "Run3j:", i, myEvt.Run3_jTau_iso.at(i), myROI.Iso
    ...
    for candTau in run3Taus:
        ...
        nFull += 1
        if newDR < 10000.0 and abs(candTau.Eta())<1.37: #abs(candTau.Eta())>1.52 and abs(candTau.Eta())<2.47: #abs(candTau.Eta())<1.37:
            nDR += 1
...
myNewFile = ROOT.TFile("output/turnOnCurve_minbiasCTj_Timing_New_eFEXeiso_Eff.root", "RECREATE")
